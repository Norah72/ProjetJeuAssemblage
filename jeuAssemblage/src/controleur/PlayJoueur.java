...
public class PlayJoueur implements InterfacePlay{
            ...
            while(choix == -1){
                ...
                try{
                    if(choixScan.hasNext("r")){
                        choix = -2;
                    }else{                                      //On vérifie si le choix du joueur est vallide (dépasse pas les limites et dans le bon format)
    ...
    public ArrayList<Integer> selectPiece(int largeurPlateau, int longueurPlateau, PlateauPuzzle plateau){
        ...
        while(plateau.getPiece(coo) == null){                           //Tant que le chois n'est pas valide, on continue
